...
export const KODAIKANAL_TRIP: Trip = {
  ...
  // Official supplied local Kodaikanal photography (Web-safe root-relative paths)
  heroImage: '/images/kodaikanal/kodaikanal-hero.jfif',
  galleryImages: [
    '/images/kodaikanal/kodaikanal-lake.jfif',
    '/images/kodaikanal/kodaikanal-hills.jfif',
    '/images/kodaikanal/kodaikanal-waterfall.jfif',
    '/images/kodaikanal/kodaikanal-viewpoint.jfif',
    '/images/kodaikanal/kodaikanal-pines.jfif',
    '/images/kodaikanal/kodaikanal-road.jfif',
    '/images/kodaikanal/kodaikanal-landscape.jfif',
  ],
  isFeatured: true,
  isAvailable: true,
};
...
export const EXPERIENCE_FEATURES: ExperienceFeature[] = [
  {
    ...
    iconName: 'compass',
    imageBg: '/images/kodaikanal/kodaikanal-lake.jfif',
  },
  {
    id: 'exp-2',
    title: 'Rush Less',
    ...
    iconName: 'wind',
    imageBg: '/images/kodaikanal/kodaikanal-hills.jfif',
  },
  {
    id: 'exp-3',
    ...
    iconName: 'users',
    imageBg: '/images/kodaikanal/kodaikanal-waterfall.jfif',
  },
];
