...
export const KODAIKANAL_TRIP: Trip = {
  ...
  // Official supplied local Kodaikanal photography
  heroImage: '/images/kodaikanal/images.jfif',
  galleryImages: [
    '/images/kodaikanal/images (1).jfif',
    '/images/kodaikanal/images (2).jfif',
    '/images/kodaikanal/images (3).jfif',
    '/images/kodaikanal/images (4).jfif',
    '/images/kodaikanal/images (5).jfif',
    '/images/kodaikanal/images (6).jfif',
    '/images/kodaikanal/images (7).jfif',
  ],
  isFeatured: true,
  isAvailable: true,
};
...
export const EXPERIENCE_FEATURES: ExperienceFeature[] = [
  {
    ...
    iconName: 'compass',
    imageBg: '/images/kodaikanal/images (1).jfif',
  },
  {
    id: 'exp-2',
    title: 'Rush Less',
    ...
    iconName: 'wind',
    imageBg: '/images/kodaikanal/images (2).jfif',
  },
  {
    id: 'exp-3',
    ...
    iconName: 'users',
    imageBg: '/images/kodaikanal/images (3).jfif',
  },
];
